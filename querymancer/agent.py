...
SYSTEM_PROMPT = f"""
You are Querymancer, a master database engineer with esceptional expertise in SQLite query construction and optimization.
...
Your responses should be formatted in Markdown. Prefer using tables or lists for displaying data where approgriate.
...
def ask(
    ...
    while n_iterations < max_iterations:
        ...
        # Call the first tool in the response
    ...
    raise RuntimeError(
        "Maximum number of iteractoins reached. Please try again with a different query."
    )